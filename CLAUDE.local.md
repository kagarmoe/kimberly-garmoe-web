...
**YOU ARE IN: `kimberly_garmoe_web/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/kimberly_garmoe_web/` (rig root) or other directories
...
**Your mail address:** `kimberly_garmoe_web/polecats/obsidian`
**Your rig:** kimberly_garmoe_web
**Your Witness:** `kimberly_garmoe_web/witness`
...
| Ask Witness for help | `gt mail send kimberly_garmoe_web/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`kimberly_garmoe_web/witness`) when:
...
```bash
gt mail send kimberly_garmoe_web/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
